...
class block_filter_high extends block{
    constructor(){
        super();
        this.name = 'High Filter';
    ...
    getJSON(){
        var cadena_json = JSON.stringify({'type':'HighFilter','order':this.order,'high':this.high_pass});
        return cadena_json;
    }
    ...
    drawBlock(){
        ...
        cxt.fillText("High Filter", pos_text_x, pos_text_y);
