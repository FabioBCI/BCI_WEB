...
class block_filter_low extends block{
    constructor(){
        super();
        this.name = 'Low Filter';
    ...
    getJSON(){
        var cadena_json = JSON.stringify({'type':'LowFilter','order':this.order,'low':this.low_pass});
        return cadena_json;
    }
    ...
    drawBlock(){
        ...
        cxt.fillText("Low Filter", pos_text_x, pos_text_y);
